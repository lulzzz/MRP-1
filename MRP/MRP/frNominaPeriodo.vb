Public Class frNominaPeriodo
#Region "Documentación"
    '----------------------------------------------------------------------------------------------------
    'FECHA:         03/07/2016 
    'DESARROLLADOR: Marlon Aldana
    'DESCRIPCIÓN:   Catálogo de periodos de nóminas
    '----------------------------------------------------------------------------------------------------
#End Region

    Dim ControlesMaestros As New ArrayList

    Private Sub frNominaPeriodo_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        UcNavegador1.NombreTabla = "tbl_mrp_nomina_periodo"
        UcNavegador1.QueryBuscar = "SELECT id_nomina_periodo Código, nmp_descripcion Descripción, CASE id_estado WHEN 1 THEN 'Alta' ELSE 'Eliminado' END Estado FROM " + UcNavegador1.NombreTabla + " ORDER BY id_nomina_periodo ASC"
