...
#Region "Documentación"
    ...
    'DESCRIPCIÓN:   Catálogo de status
    '----------------------------------------------------------------------------------------------------
#End Region

    Dim ControlesMaestros As New ArrayList

    Private Sub frStatus_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        UcNavegador1.NombreTabla = "tbl_mrp_status"
        UcNavegador1.QueryBuscar = "SELECT id_status Código, sts_descripcion Descripcion, CASE id_estado WHEN 1 THEN 'Alta' ELSE 'Eliminado' END Estado FROM " + UcNavegador1.NombreTabla + " ORDER BY id_status ASC"
