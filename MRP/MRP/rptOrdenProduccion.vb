...
Public Class rptOrdenProduccion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "MRP.rptOrdenProduccion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptOrdenProduccion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptOrdenProduccion = New rptOrdenProduccion()
        rpt.Site = Me.Site
        Return rpt
    End Function
